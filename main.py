...
def precision( query_result, judgements, arg = None ) :
    ...
    if arg != None :
        ...
        documents_selec = arg
    pertinents_selec = len( [doc for doc in query_result if doc[0][-1] in list(zip(*judgements))[-1]] )
        ...
        if( option3=='Vector space model' and option4 != '-' ) :
            if( button_search ) :
                ...
                if not results :
                    ...
                    st.line_chart( df, x=None, y='Precision', color = '#228B22' )
